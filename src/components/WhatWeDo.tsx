  ...
  return (
    <section id="do" ref={container} className="py-16 md:py-24 bg-charcoal text-white relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-12 lg:gap-20">
        ...
        {/* Left Column - Image */}
        <div className="w-full md:w-1/3 flex flex-col order-2 md:order-1 pb-16 md:pb-0">
          <div className="do-content hidden md:block">
            <h2 className="font-sans text-sm font-bold tracking-widest uppercase text-white/50 mb-8 lg:mb-12">{t('do.sectionTitle')}</h2>
          </div>
          <div className="do-content relative w-full sm:max-w-sm mx-auto md:max-w-none md:mx-0 rounded-2xl overflow-hidden bg-charcoal/50 flex items-center justify-center mt-auto">
        ...
        <div className="w-full md:w-2/3 flex flex-col order-1 md:order-2">
          <div className="do-content md:hidden mb-8">
          ...
          {/* Trust Indicators */}
          <div className="flex flex-col sm:flex-row flex-wrap gap-x-8 gap-y-4 md:gap-y-6 do-content pt-8 border-t border-white/10">
            {trustIndicators.map((indicator, i) => (
              <div key={i} className="flex items-center gap-4">
                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-lime/10 shrink-0">
